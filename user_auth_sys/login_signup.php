            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="form-text">Tip - Username is case sensitive
                        </div>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="form-text">Tip - Username is case sensitive</div>
                    </div>
                    <div class="mb-3">
                    ...
                    <p id="" class="form-text">Already have an account? <a data-bs-toggle="modal" href="#loginModal"
